...
unlocked to sign the Moselbit-Qt.app bundle.
...
allowing somebody to distribute a Moselbit-Qt.app or moselbit-qt-setup.exe with a valid
...
that the moselbit-qt.exe file inside the installer had not been tampered with.
