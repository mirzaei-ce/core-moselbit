...
#ifndef MOSELBIT_TEST_SCRIPTNUM10_H
#define MOSELBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Moselbit Core 0.10.0, for cross-comparison.
 */
public:
