...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/moselbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Moselbit Core"),
     ...
     * override -datadir in the moselbit.conf file in the default data directory
     * (to be consistent with moselbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
