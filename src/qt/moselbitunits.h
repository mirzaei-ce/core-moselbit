...
#ifndef MOSELBIT_QT_MOSELBITUNITS_H
#define MOSELBIT_QT_MOSELBITUNITS_H
...
/** Moselbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MoselbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MoselbitUnits(QObject *parent);

    /** Moselbit units.
      @note Source: https://en.moselbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MBT,
...
typedef MoselbitUnits::Unit MoselbitUnit;

#endif // MOSELBIT_QT_MOSELBITUNITS_H
