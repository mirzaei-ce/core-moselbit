...
This document provides guidelines for internationalization of the Moselbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `moselbit_en.ts` remains unchanged.
