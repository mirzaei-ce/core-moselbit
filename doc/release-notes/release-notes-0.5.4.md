Moselbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/moselbit/files/Moselbit/moselbit-0.5.4/
...
http://gitorious.org/moselbit/moselbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Moselbit-Qt notifications under Growl 1.3.
Increase required age of Moselbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMoselbit properly when installing Moselbit-Qt over it. (Windows)
