Moselbit Core version 0.9.4 is now available from:

  https://moselbit.org/bin/0.9.4/
...
this update is incompatible with the Moselbit system and could lead to consensus
forks.

Moselbit Core released binaries from https://moselbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~moselbit/+archive/ubuntu/moselbit
- A third-party or self-compiled Moselbit Core

upgrade to Moselbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
