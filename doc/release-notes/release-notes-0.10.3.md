Moselbit Core version 0.10.3 is now available from:

  <https://moselbit.org/bin/moselbit-core-0.10.3/>
...
(see https://github.com/moselbit/moselbit/pull/6793, as well as the 0.11.0
