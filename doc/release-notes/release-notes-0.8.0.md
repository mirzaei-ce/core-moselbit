Moselbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/moselbit/files/Moselbit/moselbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Moselbit
...
New/changed settings (command-line or moselbit.conf file)
--------------------------------------------------------
